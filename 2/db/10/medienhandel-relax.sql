...
INSERT INTO bestellung VALUES
  ('BE-0020', date('2006-08-02'), 'P020', 'Internet'),
  ('BE-0049', date('2006-10-23'), 'P019', 'Postweg'),
  ('BE-0010', date('2006-07-23'), 'P020', 'Internet'),
  ('BE-0023', date('2006-08-11'), 'P023', 'Internet'),
  ('BE-0056', date('2006-11-15'), 'P022', 'Kurier');
...
INSERT INTO angebot VALUES
  ('0001-E', 4.99, date('2006-12-31')),
  ('0003-E', 0.50, date('2006-12-31')),
  ('0006-B', 7.50, date('2006-07-01')),
  ('0007-B', 11.90, date('2006-08-01')),
  ('0007-B', 5.00, date('2006-12-03')),
  ('0012-T', 14.90, date('2006-06-01')),
  ('0013-D', 9.95, date('2006-08-01')),
  ('0013-D', 12.95, date('2006-10-05')),
  ('0017-V', 14.90, date('2006-06-30')),
  ('0017-V', 10.00, date('2006-12-03'));
